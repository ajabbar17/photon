...
const HeroSection = () => {
  return (
    <div className="h-[110vh] bg-[#0d2538] relative  mb-10 z-40 overflow-hidden">
      {/* Hero Section */}
      <div className="relative h-[68vh] md:h-[75vh] z-40 wrapper">
      ...
      {/* Circle with arrow */}
      <div className="absolute bottom-64 md:bottom-44 xl:bottom-52 left-1/2 transform -translate-x-1/2 z-50">
